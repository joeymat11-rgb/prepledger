...
function validateStep(a){
  ...
  for(let i=0;i<45;i++)if(a.inventory[i].defect!=='D12'&&!eq(a.inventory[i],parent.inventory[i]))fail('CARRIED-OR-UNSELECTED-INVENTORY');
