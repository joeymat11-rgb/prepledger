...
- Static inspection only at integration `b46f4e3d9809efee98229e8ff1911249c6e09874`; the child was not run.
...
- Current S9 spec SHA-256: `e1a53e35ed3841749c5fabe5d2ff8a744e28bfc658f779135c01d599a7bd4397`.
...
- Failure is a thrown assertion/nonzero exit. Custom messages include path and 12-hex fingerprints, while uncaught `assert.equal` diagnostics may also print full 64-hex actual/expected digests; no protected source contents are intentionally emitted.
