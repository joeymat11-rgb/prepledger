...
const root=path.resolve(__dirname,'../../../..'),C='f2dea2ec8426d12e95483e180821839fbf1165f7',M='100820aa47a4f8729642033499eaec0f0ee282e1';
...
const manifest=JSON.parse(fs.readFileSync(path.join(root,'.tmp/er-b1b2-r4/tooling-manifest.json')));for(const row of manifest.files)assert.equal(sha(fs.readFileSync(path.join(root,row.file))),row.sha256,row.file);
...
fs.writeFileSync(path.join(root,'.tmp/er-b1b2-r4/results/authority-evidence.json'),JSON.stringify(evidence,null,2)+'\n');console.log(JSON.stringify(evidence));
