...
const root=path.resolve(__dirname,'../../../..'),base=path.join(root,'.tmp/er-b1b2-r4'),pub=path.join(base,'public'),prior=path.join(base,'prior-public'),results=path.join(base,'results');
const C='f2dea2ec8426d12e95483e180821839fbf1165f7',OLD='c4716edad91453e74ba17f70ab076781ff5367de';
...
const previous=json(path.join(root,'.tmp/r4-review/prior-r2-evidence.json')),manifest=json(path.join(base,'public-manifest.json'));
