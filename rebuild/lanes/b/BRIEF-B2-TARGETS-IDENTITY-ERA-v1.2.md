# EARNED — LANE B · PACKAGE B2 — TARGETS, IDENTITY & TECHNIQUE ERA — BEHAVIOUR/DELTA BRIEF **v1.2, POST-REVIEW-r1 AMENDMENT** (PROPOSED, NOT ACCEPTED)

## v1.2 amendment (post-review r1) — READ THIS FIRST, BEFORE THE v1.1 NOTE BELOW
...
### v1.2-A2. Q2 — the convention at `volume.cjs:159` — **PM-OPTIONAL, ON ITS OWN COMMIT**
...
widening it to former names would be a second, unrequested behaviour change. `volume.cjs` gains no import.
...
**Still open for the PM, unchanged:** every question Q1–Q9 of §7. Q2 now has a hunk on a revertable commit
and Q8 now has the executed inertness finding beside it; neither is answered here.

---

*Everything from here to the end of the file is `BRIEF-B2-TARGETS-IDENTITY-ERA-v1.1.md` carried WHOLE and UNEDITED (its own H1 replaced by the v1.2 line above). Section numbers, the identity convention C1–C6 in §2, and the PM questions Q1–Q9 in §7 are byte-for-byte v1.1; where v1.2 corrects a sentence it is quoted and replaced in the amendment, not rewritten below.*
