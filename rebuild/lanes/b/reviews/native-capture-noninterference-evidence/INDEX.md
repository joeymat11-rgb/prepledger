...
captures/ contains155 original public files from28 actual invented Node child launches;38657 bytes.
Phases remain distinct: red8ab80f3b0/4; prototype0282f3f2 targeted12/12; resource-probed05ef3e90/1.
The intermediate passing cohort does not override the later resource noninterference failure.
All tracked source references resolve at their recorded immutable commits, including prospective input hashes.
No new driver, test run, copied runtime/package, synthetic repo/worktree or original native/private input.
Exact Git blobs bypass line-ending filters so raw CRLF bytes, where present, remain unchanged.
