...
try {
  for(const [index,config] of configurations.entries()) {
    ...
    if(config.journey) {
      ...
      await page.waitForSelector('#phone [data-slot="gym-card"]',{state:'attached',timeout:20000});
