...
- Sans weights 400 to 500 only. Titles in row cards and pill labels are 500; body 450 to 480; sub lines 430. *gate (type sizes and weights on the scale, which WARNs on a new weight)*
