...
## September10 — rev170 UI adoption and U1 portability fix

PM/APM fully read original21452-byte CONFIGURED-LOAD-UI-REV170-REVIEW.md and verified SHA256018da1df792dab9d28f434b071575f0b965a959c9d2d4afbbd889d57b03f86c9. Adopt scoped ACCEPT with required U1 test repair. Exact three accepted runtime source hashes are retained: command-panel1a9cd8196217e438c1100e8fd38928e3d22ec1c393c8f470174878a30700c865; prepared-panele3f316b6e935f86422affe33e3c4647d43a39eba66f7290fdb03e0a6181a7a56; load-fieldf97df67bd0ffb94be55449d3d0a554e9803e62db174018da4a667c10d4c00459. Two actual e084 preimages verified; new helper/test absent before adoption. Original builder report appendix6f2882cdf44b5bdd7b06adb29004c90c431fd34b60fc2f6924f0ce2bdee56336 appended after the complete current e084 report, preserving newer notes. Immutable original input/candidate/report remain unchanged. Older dispatched/pending paragraphs below are historical.

U1 reproduced on this PC with unequal source/candidate folder depths: old comparison fails on the byte-identical @noble/hashes/utils.js dependency before browser launch. New test-only configured-load-graph helper resolves dependency real paths and root-relative product identities, refuses duplicate/missing/unexpected identities, compares each unchanged hash, and requires exact declared hashes for composed inputs. No loose content multiset, arbitrary path replacement or depth-matching workaround. Four focused regressions PASS: unequal depths, missing/extra/duplicate, changed dependency/product and exact allowed composition/addition. Original browser build/font/cipher guards and all existing browser assertion files unchanged.

Retained-checkout adaptation before running: original Fable test recursively copied its public-only packet's rebuild tree. This checkout also has private fixture/engine directories (existence only checked), so test now copies only public paths already named in the retained bundle inventory plus build-browser/cipher-imports, and links existing dependencies by Windows junction. It does not traverse private/ledger/engines/seed or copy dependency trees. Initial guard refused a node_modules path in the public set before reading it; corrected to exclude dependency paths, then reproduced actual U1. That setup refusal is not counted as the U1 red witness. No private files inspected/copied or product dependency/lock changes.

Actual fixed browser proof PASS on Windows Node24.19.0, locked playwright-core1.62.1, installed Chrome152.0.7977.83:40 DOM +27 native +4 keyboard, eight screenshots,61 retained/63 candidate bundle inputs. Same real AES-GCM/IndexedDB prepare/multi-set/finish/reopen/both correction directions/quota and unknown/refusal semantics. PM inspected entry-configuration-390/history-390 screenshots: exact configured labels, original prescription and numeric/configured recorded values remain distinct. Evidence C:/Users/joeym/AppData/Local/Temp/earned-ui-u1-fixed/configured-load/evidence.json SHAa7a791f11fa434a983694f30e098ba0907973fcc3979cc20861125445d8f3043. Explicit synthetic unissued lease/producer/guard and scratch value dependency remain; no genuine schema2 issuance/phone/science claim. Installed Chrome is not the driver's pinned browser; this is not exact-lock browser evidence. Prior independent original panel/prepared-panel controls reused because accepted runtime bytes are exact; no duplicate whole UI campaign.

Final browser test6c96008fcc10d764caa82bbe68a14dd6058b162c10a237babc5d4a85a26c4105; helperaa30aee38c703896296ed022f0727dc3137134249a9c1b31eced51a47108e493; regressione26122a83f01fce5dba15ba3dc9ed065311fe63fc7e4854a0ba55bdffd79c9b3. Coordinator logs: outputs/UI-U1-red.logb1a69bf4d2e2f60e100fddffc22c791ff84d9b72a557e793180a3c120cc5b06d (initial copy guard); UI-U1-red-2.logf8edacd6046278529eaf18b8f5d7cb0ec508b42ad5b84e9bed0be1e4d06bbd88 (actual defect); UI-U1-fixed.logdb1bbc664fe160533ae4dc520b9e8f75b94ca3532b5d99e8a6109a9efbbb9fb5. All jobs terminal; no browser/server helper left running by the successful harness.

U2 mode-switch retained text remains nonblocking; U3 retired-editor recovery and U4 legacy zero-load reps-only correction remain pre-existing unresolved product conditions. Do not claim them fixed. U5 keeps builder Node22/driver1.56/Chromium141, reviewer Node24/driver1.62/Chromium141 and PM Windows Node24/driver1.62/Chrome152 separate. APM advises coherent value/history/reader switch after already-queued typed-reader/trend verdict; do not allow configured writes with a rejecting downstream reader. Current retained wire still refuses configured saves as its original baseline should; candidate native proof exercises accepted value dependency explicitly. U1 followup belongs to integration review, no new Fable fix lane or repeated full campaign. Complete source/context/science/manifest/issuer/recovery/device/integrator/release remain. No push/merge/deploy/private activation.

## September10 — isolated configured-load UI builder dispatched

Only this report and BRIEF-W6 change locally. Under explicit owner parallel-development authorization, PM prepared exact public packet CONFIGURED-LOAD-UI-5cd574e-builder.zip1413261B SHA dc895fa4c8c5a33607b828206aee6b7159adaf56279a724e636299ef62c8e553,308-file manifest44410297bd9ea451ec12db28b92a28c810e9337f9a7c7a95388ab919db39a701. Manager fully read assignment, verified all files and dispatched once to distinct existing Fable5.1 High/Fastoff builder018tEDZ11mqw59Xewx3VeSvB. Exact source baseline5cd574e; public R1 supportbb2fd67 labelled separately; isolated scratch only, old memory evidence preserved. UI command/prepared panels, small shared UI helper and affected tests/report are owned; PM's M4 history projector remains separate. Native entry/reopen/prepared-correction validation is required; no UI implementation result yet. Builder cannot self-accept, no retained schema/issuer/private activation/push/merge/deploy. Rev168 finite value-candidate ACCEPT and F1–F4 conditions now received by PM; Manager/APM coordinate their delivery to builder. No new runtime tests are justified for these two documentation changes.
...
The following delta is separate: recovery-local's inactive candidate exposes inspectSourceSelection through the SAME verified profile.sourceSelection method. Existing check() runs before lookup, before visitor and after awaited visitor. No material assembly, new inventory/authentication layer or detached authority is introduced. M4v0.79 binds every accepted source control to its verified metadata/receipt, including nontraversed B after rollback A; bare source type no longer exempts an operation.

Actual changed signed source/recovery witness1/1 PASS in198.8seconds, `.tmp/bound-source-signed-recovery.log` SHA7eadc79a7b477072fa5ebc508673ecea39779d0680e240f771988f44fa5c88da. It checks unknown metadata, caller-copy isolation, actual final local-revision refusal after exactly one metadata visitor invocation, retired-reader refusal, unchanged pending records and import/rollback/reopen. Composition `C:/Users/joeym/AppData/Local/Temp/earned-source-recovery-zGDm9R`271 copied pins/22 M4 code pins reverified; source codec/authority unchanged. Actual schema1 signed synthetic source evidence is not a genuine schema2/native workout witness. M495/95 affected PASS; exact canonical unbound-source predecessor RED and final log hashes are in M4 report. No PM job remains, no broad resource/numeric/conformance rerun, no private data in public review, no push/merge/deploy. Affected independent acceptance of this successor is pending.

## Shared context history candidate — September10
...
Actual storedWorkoutHistory now exposes each original context row with the interpretation from that same fold; existing workout projection is unchanged. Runner/pin manifest explicitly includes context-values, avoiding a missing copied dependency. Final .tmp/context-history-bound-target-composed.log SHA f705fe79bca3ecb32dafb4e67f85dba8837ed69fcb75e9f2071ea2704097c461:431/431, actual Chromium current-head5,56 Node/browser vectors,6 signed surfaces/36 refusals and public sink PASS. Composition C:/Users/joeym/AppData/Local/Temp/earned-w6-current-head-OYqEXG preserves the old R1bec056d base plus two current codecs/current W6 overlay; not full current-R1 authority qualification. M4 exact actual-root/stored/native13 cases are part of91/91 affected PASS; unchanged workout schema86 PASS.

Initial run accidentally used --bite, intentionally removing the revision assertion in disposable2Mg7aU, and omitted W6_BROWSER_BIN. Its two expected race failures and isolated repeat are retained, not called a product regression. The normal reruns pass with installed Chrome; retained public-client.mjs was never changed. Final source pins follow the target-family correction preventing source-control edits through class:event; no guard or fixture was weakened. No phone/CLOCK/full-standing, genuine v2 issuer/recovery, private activation or independent runtime verdict follows.

## Source-aware capture preparation/resume — local candidate, September10

Based on2141c86. Explicit earned/workout-prescription/v2 adds the existing source_basis frontier to closed immutable capture and expected context; v1 remains readable unchanged. Shared schema references, command expected context, stored historical dispatch, guarded source-cut forwarding and current-head test composition are updated. PM adopted exactly the two-file CAPTURE-SOURCE-HOST-01 patch after reading production/test delta and verifying270 original/live/candidate pins, log hashes and preimages. APM scoped acceptance applies to this host adapter: selected-source Start requires explicit causal parent, source context is copied from static resolver, resume uses current B while original A/v1 remains exact, and existing revision/token/CAS/duplicate/uncertain Start fences remain. Patch SHA c14e4ee97a4956d92e08b58918d064c9c7c4cee9cc2dc2fbe3860cf4beb55439. Helper full125/new23 PASS;20 reached pre-patch failures retained.
...
Actual source/producer prerequisite1/1 PASS in168.8seconds at earned-source-recovery-kCJ839; synthetic producer identities are unqualified. Host fixtures use explicitly synthetic source/policy callbacks and do not authenticate a real source projection. Full signed A/workout/B/workout/rollback/reopen with delayed accepted A Start, actual replay membership/mixed chronology, source-aware authority/issuance/current safety/science/phone/private gates remain. No full C2 or release claim.
...
Actual legacy T2 load/reps and direct causal corrections now survive the same signed-history/encrypted-save/fresh-read path. Missing original capture no longer erases supported quantities. Raw lift/slot stay identified as old recorded context; reserve remains unknown even when an extra payload field spells reserve. Old Close retains its original flag without being assigned normal/early meaning. Accepted legacy edits require explicit target causality and a causally ordered direct chain; concurrent, post-removal, unsupported/nested effects and invalid originals remain contained with explicit issues. Unsupported target effects such as reclassification stay attached rather than disappearing. Valid unrelated sets remain readable. No raw slot becomes a captured position or lift lineage.

The actual host separately displays associated older workouts from that authenticated read, without matching them to the current split or offering legacy controls. Unknown instructions/effort/end type are explicit; original values remain reachable. Malformed original quantities cannot crash formatting. This is a factual history increment: unresolved/unassociated originals remain in the reader, and qualified legacy/source/capture/currentness/engine mapping is still required before these records can guide a new prescription.

Seven focused signed durable cases PASS; the first five failed at the intended assertions on the previous runtime (.tmp/legacy-history-before.log). Actual native host reached the missing older-section witness before the host fix, native exit1 (.tmp/legacy-history-native-before.log). Final exact W6/R1 public composition406 PASS/0fail/0skip and native resume/correction/history65 PASS, including actual old T2 writes, signed pull, encrypted storage, page close/reopen, original values, no extra Start/producer call and320px/200percent text. Log .tmp/legacy-history-candidate-final.log; composition C:/Users/joeym/AppData/Local/Temp/earned-w6-current-head-eDm7nZ. Screens retained under .tmp/legacy-history-candidate-final/workout-resume; initial successful native renders were visually inspected under .tmp/legacy-history-native-first/workout-resume. M4 actual reader/capture/order47 PASS (.tmp/legacy-history-engine-final.log in M4). Original conformance99reference/99strong/29specified absent-family RED/70present-family GREEN, rig185 and SELFTEST PASS in R1 .tmp/legacy-history-{conform,selftest}.log. Strict with test clock unset PASS (.tmp/legacy-history-strict.log). Shared module SHA9d29d72c069f090dc7c22259da12d1f20427b1ea49d77778443c33fafef34b4b; exact current source pins are in test/shared-edit-source-pins.json.

These are synthetic identities, signing/lease/clock/enrollment and producer configuration. No actual issuer, private profile, scientific eligibility, hosted resource or physical-phone qualification is claimed. Original96MiB failure and designated integrator/private/device gates remain. Existing schema/core evidence retains its unchanged scope; no duplicate legacy fold or new review campaign was added.

## Shared typed workout edits in retained history — September10

Local successor to48ddeeba; M4 base3ecb8fc/R1 base98c1405. Manager read scoped Message65 ACCEPT of9e14919's corrections/proposed amendment; APM then read and accepted the exact W6/R1 implementation boundary before runtime edits. This candidate still needs independent runtime/integrator acceptance. No T2/authority core/issuer/codec/SQL/installed engine/frozen source edit, merge, push, deployment or private activation.

New edit-values.cjs supplies shared effective-time/recorded/replacement domains. Existing schema/profile now support target-specific Start/Set/Skip/Close and nested correction/removal replacements, conditional rooted lift lineage and optional clearing only in replacement paths. No malformed Set-admission claim: actual shape already refused malformed recording; the candidate preserves that while adding clear instructions to edits. Target chains use the existing dependency reader, so missing/unaccepted dependencies still WAIT/refuse before admission or acknowledgment.

New edit-history.cjs consumes all typed rows from the privately authenticated complete generation. stored-history preserves sameRecordedValue comparisons and complete prefix before filtering; no fabricated operationBytes or permission flag. One reverse dependency fold keeps accepted original/effective values, nested correction positions, removals/restoration and per-root issues. The same fold forms a separately labelled local view only with supported order; concurrent pending effects remain unresolved and accepted values stay independently accessible. Unknown legacy context/lineage and unsupported records remain explicit. Non-workout originals stay in their original custody without copying their potentially large payloads into the workout display.

project-history is now an adapter to that fold, including Start/Skip/Close. Resume uses corrected date/slot/Skip liveness with original capture intact. New-Start preparation authenticates history even without an engine projector and requires a live unambiguous Finish; removing Finish cannot unlock another Start. M4 rechecks complete applicable membership/status and the same shared result before actual factual-reader input. No currentness/generation/answer restoration, complete session/slot partition or progression permission follows from field restoration.

Four actual W6 command/save/reopen cases pass: nested edit/revise/remove/restore while preserving unrelated sets; optional reserve clear versus invalid recorded clear; corrected Start/Skip/Close and removed-Finish refusal; signed-test accepted ties versus separate unresolved pending effects. First two reached the intended old-command refusals before implementation (.tmp/shared-edit-history-before.log). Final actual public W6/R1 composition399 PASS/0 failures/0 skips, native retained reopen/resume/normal Finish/correction/removal52 PASS: .tmp/shared-edit-history-candidate-final.log SHAc8e6760ada1f0d1ef53eb4010cc2666ca1409f9ffb049f185ded2a3a805f6afd, composition C:/Users/joeym/AppData/Local/Temp/earned-w6-current-head-qctQ1y. Exact shared source pins are test/shared-edit-source-pins.json; R1 consumes schema/profile/edit-values, W6/M4 additionally consume edit-history. The runner no longer falsely describes these modules as the old accepted two-line capture delta.

Native prepared40 plus7 presentation/7 controlled observer PASS including offline fonts and320/390px/enlarged text; .tmp/shared-edit-history-panel-final.log and .tmp/shared-edit-history-native-final/prepared-panel inventory/screens. Existing full native journey artifacts: .tmp/shared-edit-history-candidate-final. Four deliberate runtime faults were effective in a disposable actual composition: earlier edit position, optional clear, accepted order, and removed-Finish guard. Baseline4/restored4 PASS; every source pin restored. .tmp/shared-edit-history-faults/evidence.json SHA4803f9aa13318041c136c93e40780d6b2fe306e728c392f5a6038bd9128f8e3b; root work/check-shared-edit-history-faults.cjs records reproduction, not another product reducer.

M4 actual reader/capture/order47 PASS, shared shape86 PASS with81 original primitive/byte controls; R1 actual core39 PASS including nested WAITING drain and target-domain refusal. Required original conformance99 reference/99 strong/29 specified absent-family RED/70 present-family GREEN plus rig185 and SELFTEST PASS, R1 .tmp/shared-edit-history-{conform,selftest}.log. W6 strict PASS with test clock unset, .tmp/shared-edit-history-strict.log. Generic shipping text grants no permission.

Preserved setup/compatibility failures: direct W6-only full prepared test lacks three currentHead dependency functions; final actual R1 composition passes them. First composed run397/399 failed two pure candidate-component tests because their synthetic inputs changed original dates rather than the new current-date view; fixtures now use the explicitly synthetic current view with unchanged rule expectations. No product rule was weakened. Full genuine schema2 issuance/recovery, legacy mapping, configured-load/extension/partition/currentness, scientific/private/phone/resource qualification remain open; signed-test capabilities and receipts are not issuance evidence. Full UI is still unfinished, including heavily wrapped enlarged-text summaries. The fixed9e14919 packet remains unchanged historical accepted input.

## Approved Instrument typography — September10, successor to05c38cf

The actual retained command/prepared panels now install the approved Instrument Sans and Instrument Serif once per document. Four exact upstream font/license files and SOURCES.json retain repository commits, byte counts, Git blob identities and SHA256 pins. The browser builder allows only those named assets, verifies bytes and embeds fonts and original license notices; there is no runtime font network request. Existing authority/crypto import restrictions are unchanged. The fixed9e14919 review packet remains untouched.

Native prepared-panel checks40 PASS with networking disabled before mount, both fonts decoded, and one shared stylesheet; presentation7 and controlled observer7 pass. Existing320/390px and200% text fit/control checks pass. Screenshots were inspected at320px normal and enlarged text: normal typography matches the approved families; enlarged text remains available but wraps heavily in two-column summaries, so these checks do not constitute complete responsive-design acceptance. Evidence and source inventory: .tmp/approved-local-typography/prepared-panel; execution .tmp/approved-local-typography.log.

The complete retained W6/R1 test composition passes395 tests, zero failures, plus52 native same-workout resume/Finish/history/correction/removal checks. Log .tmp/approved-local-typography-composed.log SHA bfafab9ab73988b62a921eea94dbf4b1b7de5f0551c075dfb024d0836c014f36; disposable composition C:/Users/joeym/AppData/Local/Temp/earned-w6-current-head-ZBbEOR; native artifacts .tmp/approved-local-typography-final. Strict repository check passes with test clock unset, .tmp/approved-local-typography-strict.log; its generic shipping sentence grants no release permission. No schema, persistence, currentness, engine, scientific or private-use qualification is inferred. Full conformance/SELFTEST evidence for unchanged engine/client behavior remains in the immediately preceding presentation cut. No merge, push, deployment or private activation.

## Approved workout presentation and current-guidance withdrawal — September10

Local successor to667e34d, under the pre-edit BRIEF-W6 presentation scope and owner-approved Refinement A. The SAME compiled prepared host and durable command panel now show current-exercise set positions by exact lift lineage. Recorded repetition counts and explicit Skipped labels come only from interpreted continuation or acknowledged local actions. Saving/refusal cannot mark a set recorded. After an acknowledged Set/Skip, the entry form remains in the DOM but yields visually to saved feedback and explicit Next/Finish; keyboard focus follows that available action. Explicit Next restores blank performed fields and unrecorded effort. Original capture/identity and all command/storage logic remain unchanged.

Per-set setup/reason/confidence are available beside original targets. Current details collapse only when all six load/reps/effort/setup/reason/confidence cells exactly match the original; any difference opens the current assessment, and the governing current reason remains visible. A fresh assessment failure now withdraws previously current fields, leaves original instructions and typed values visible, disables continuing through the existing permission path, and gives Reopen/recovery guidance. The host maps this pre-command failure to a presentation-only WORKOUT_CURRENT_ASSESSMENT_UNAVAILABLE refusal; no wire/schema/currentness policy changed. Thrown preparation failures take that same display path. No previous-performance comparison, timer, Undo, target prefill, ready status or private prescription was invented.

Final actual W6/R1 public composition:395 tests PASS/0 skipped, native resume/correct52 PASS. W6 .tmp/approved-workout-presentation-composed-final.log SHA505283e79fc8f01d232c99eff88d827680ff636372992ab32d4f444ab9e5cb2d; disposable composition C:/Users/joeym/AppData/Local/Temp/earned-w6-current-head-umiMQQ contains fixed public source-manifest.json and terminal result.json. Includes same Start, normal Close, page disposal/reopen, recovered values/current safety difference, failed assessment without append, correction/removal/stale-editor and unchanged later facts. Native prepared38 plus7 presentation/7 controlled observer checks pass. Existing panel57 controlled/38 extension checks and actual delayed/quota Set/Skip/Close/encrypted-reopen checks pass. 390/320px and200% text checks preserve fit, reachable controls and scaled inputs. These are synthetic issued-by-test schema2/producer/clock/guard fixtures in desktop Chromium, not actual issuance, personal qualification or physical-phone evidence.

Three reached historical/negative witnesses in the disposable actual browser composition: old667 command panel fails the saved-form/Next-focus requirement; old667 host fails exact per-lift progress; restoring stale current instructions after an assessment failure fails the original/current separation requirement. Current prepared38 baseline and restored resume/correct52 PASS. W6 .tmp/approved-workout-presentation-witnesses/evidence.json SHA61ab754a84455c66044255996a773e5c08e740c90837a114247d82fa5025c1fb records exact sources/assertions, with disposable and retained product bytes verified restored/unchanged. Root reproduction is retained work/check-workout-presentation-witnesses.cjs; it is one-shot evidence preparation, not product code. Final screenshots/compiled source maps are under .tmp/approved-workout-presentation-final; witness runs have separate directories. Existing browser runners now accept W6_UI_ARTIFACT_DIR to preserve named evidence cuts.

Original conformance at unchanged actual core/engine boundaries:99 reference/99 strong/29 specified absent-family RED/70 present-family GREEN, rig185 W1/W2, SELFTEST PASS; R1 .tmp/approved-workout-presentation-{conform,selftest}.log with explicit retained engine paths, M4 adapters, W6 client, TZ America/New_York and test date2026-09-03. W6 .tmp/approved-workout-presentation-strict-final.log PASS with test clock unset. No frozen/engine/authority/T2/public-client/schema/repository changes or protected soak access. The generic strict-script shipping sentence is not release permission.

Visual inspection compared the actual current/saved/recovery screens with approved Refinement-Workout.png. This closes concrete hierarchy/navigation/data-binding gaps, not full premium design acceptance: the retained host remains visibly synthetic, actual Instrument font delivery, compact effort choices, qualified prior-performance/rest/Undo and full Today/workout flows still need their real applicable integration. No merge, push, deployment or private activation. The fixed9e14919 edit-review packet remains untouched; this presentation candidate belongs in the next coherent affected integration review after the current reviewer assignment, not an interruption/new campaign.
...
Reading records retain every original and correction/removal, including rejected or orphaned effects. Accepted and local views fold separately. Pending changes never enter acceptedReads. Explicit causal ancestry orders edits; device sequence/predecessor/receipt order does not resolve concurrency. Concurrent/missing-target/unsupported edits remain unresolved without invented values; same-date observations all remain with no trend winner. Existing W6 command surface still has no generic reading edit command; actual local correction/removal evidence uses the original T2 API, while actual signed W6 integration covers admitted remote edits. No UI or controller completion is implied.

The recovered-plan guard remains first and all recovered source views remain projectionPending. Outside that guard, this factual-only seam cannot extend an old snapshot's freshness. Earlier-date effects can affect the whole estimate: direct trend/rate/maintenance and paceCurrent suppress for pending facts or unresolved/accepted/pending effects; fact:reading enters the original dependency filter, including for remote accepted edits. Other declared dependencies remain. An empty eligible date set is explicit unresolved input, never legacy fresh-by-default. This does not permanently substitute suppression for the required qualified engine/source/current producer.

Source pins: rebuild/client/index.cjs SHAfc99ff50a1b3453c5d429c40328d94b98c4d8802bc354e56e169faf66b1d65d9; rebuild/client/face.cjs SHAede658a223ddb691bf9f64737edc63507dc0d594a462e6f8f3bea9c3aeaa98f0; rebuild/m3/w6/public-client.mjs SHA6fd66a453e9d28b974fff83c8560b2c68cd4b2ece09ab77e20eeb5df12dc0810; rebuild/m3/w6/reading-history.mjs SHA76a19b7078414476886dd5967d8ac328e2bc47d38f5043021add3f3e366df4cf.

Executed evidence:
- .tmp/reading-history-focused.log12/12 actual T2/model/face checks, with deliberately synthetic receipt fixtures (not an authentication claim). Accepted/pending/correction/removal/concurrent/orphan/default/malformed/prefix tests and earlier-date suppression pass. The initial malformed-projector test incorrectly expected boot() to invoke a view; it now exercises face(), the actual consumer.
- Actual current public R1/W6 source test passes through workerd/D1/P1, source binding/recovery/rollback/reopen, five pending saves and now remote factual display, admitted remote correction/removal with originals, resealed changed-local identity refusal and late observation-context refusal. .tmp/source-reading-join.log covers edits/identity; final expanded joined baseline and injected witness are under M4 .tmp/source-projection-green.log / C:/Users/joeym/AppData/Local/Temp/earned-projection-boundary-uQpJUd. Its evidence SHAddb207aefd9ad54ec2753ee6d33392ea914c2696043e2acc6e57b78dc1a8d6e0.
- .tmp/reading-history-faults.log: six reached ERR_ASSERTION faults (own-device-only, ignored local identity, pending accepted fold, empty-date freshness, earlier-effect old estimates, accepted-date false freshness). Focused12 and signed join restore PASS. C:/Users/joeym/AppData/Local/Temp/earned-source-recovery-axHC2S/reading-fault-evidence.json SHA75846ed7e13b3cd24ea409d625a560f8468a869a3a975bd389bbc499e361c829; original product/copy pins verified restored. This predates the additional test-only late-observation assertion; runtime bytes are final.
- .tmp/reading-history-all.log395/395 PASS, exact old bec056d public dependency plus current W6, composition C:/Users/joeym/AppData/Local/Temp/earned-w6-current-head-GxEnWw. Accepted T2 cb5580a default35 laws and56 full action/state/clock vectors match exactly. Original suite/assertions unchanged.
- .tmp/reading-history-browser-final.log36/36 real Chrome checks, FULL close/relaunch, real IndexedDB/workerd signed recovery and factual/pending view separation. C:/Users/joeym/AppData/Local/Temp/earned-source-browser-HGe7t4/evidence.json SHAd919563f1f7db65ab42087b60fa29379a10bcf7b04fd65a18b3a6a8f0c70a571; composition earned-source-recovery-qQZgRh. Fixed synthetic-only key/standing; not phone/key lifecycle or qualified guidance.
- R1 .tmp/reading-history-w6-{conform,selftest}.log: W6 adapters with retained engines, conformance99/99/29/70 +rig185 PASS, SELFTEST PASS. W6 .tmp/reading-history-strict.log PASS with test clock unset. Stock Safe to ship output grants no permission.

Open: immutable imported source reads still need a demonstrated source/effect coverage join and actual accepted engine calculations, local suppression, historical/current consent reconciliation and atomic qualified publication. Original applyRead ignores subsequent same-date readings; source custody accepts empty engine context. Do not infer coverage or change that installed writer silently. Full IMPORT-ROLLBACK, private/device/science/K1/schema2/integrator/resource gates remain open. No merge/push/deploy/private activation.

## Signed source recovery joins local pending work — September9 local successor

Base0b281870fa6ed51686257afa70f738be704b4902; R1 source320b899 plus shared indexed-codec successor98c140514db7aee3c175d1a7ec1ce6d73f14a046; unchanged M4 preparation at60e4d5a. Recovery config explicitly supplies protocol:createSourceRowsCodec(), sourceCodec and protocols:[oldRowsV3,newRowsV4] when old archives exist. recovery-profile verifies the COMPLETE signed cut and original R1 relations first, then executes the SAME R1 source semantic generator through the encrypted row index. A missing source reader refuses SOURCE_PROFILE_REQUIRED; new source rows are never opaque. Source binding/material accessors are isolated and guarded by the same inventory/local revision/token/current context. Actual T2 recovery assembly preserves later accepted originals and every local pending body/outbox. All candidates remain projectionPending and inactive; no current source engine-state publisher is implemented.

Existing v1 archive proofs preserve exact fields/bytes and select only rows-v3. New v2 proof adds explicit inventory_profile rows-v4. Reopen requires its configured decoder, complete signatures, source semantics and original comparison. Missing old decoder refuses RECOVERY_ARCHIVE_PROTOCOL_UNAVAILABLE. The actual mixed-version test exposed v4 trying to decode the retained v3 live HEAD: new v4 live head now has a distinct key, while the ORIGINAL transport control/budget is shared across versions. Archive page/encryption/AAD formats and old head remain intact. Changing protocol does not reset attempts. No T2 core, schema1/2 issuance, authority transaction, installed engine or frozen app changes in this W6 successor.

New test/run-source-import.cjs explicitly composes CURRENT PUBLIC R1 + CURRENT W6, captures per-file source origins/hashes, and reuses existing dependencies. It does not relax the old recovery734 or current-head bec056d pins. The joined test executes actual M4 migration/merge preparation and W6 custody, actual workerd/D1/P1 source upload/activation binding, later other-device fact, three actual T2 pending saves, complete signed v4 recovery, rollback selection, inactive historical candidate commit, close/reopen and two more saves. Old v1/new v2 archives both authenticate; selected material/checkpoint, remote original and all five queued originals remain. Caller edits cannot mutate material/selection; publication retires prior handles. This does not claim current source projection, policy/consent, generic T2 import event issuance, controller activation or full IMPORT-ROLLBACK.

Executed evidence:
- .tmp/source-recovery-faults.log: joined1 PASS and indexed9 PASS, four effective product faults, both restored PASS. PUBLIC composition C:/Users/joeym/AppData/Local/Temp/earned-source-recovery-1iRwSG, fault-evidence.json SHA37a8cc81485e9cc8b9a6d71c1be77ae258088d706182c25840544b379c15fcfa. Faults separately prove mixed-version live-head refusal, unchanged shared transport budget, drained-prefix integrity and component-digest validation. Each must reach ERR_ASSERTION; all captured current sources restored byte-for-byte. Original product files never mutated.
- .tmp/source-recovery-browser.log:28 native Chrome checks through FULL browser close/relaunch with real IndexedDB, actual public signed workerd source recovery and actual T2 queued saves. C:/Users/joeym/AppData/Local/Temp/earned-source-browser-WVjw86/evidence.json SHA4a985f74730672a3142d48ad15a813ad6320b7e6932ed304ef13735dc54d1638; public composition earned-source-recovery-41TtKm. Fixed synthetic test-only key/standing is explicit, no account/key/phone qualification. Actual installed engine stays Node-only; only synthetic prepared bytes enter the browser. Build graph is retained in evidence.
- .tmp/source-recovery-v3-regression.log167/167 PASS against unchanged prepared .tmp/r1-734-public. .tmp/source-recovery-composed-final.log383/383 PASS against exact old bec056d public dependency plus current W6, composition C:/Users/joeym/AppData/Local/Temp/earned-w6-current-head-8l3F6J. Those old-profile checks are not claimed as current R1v4 tests.
- R1 .tmp/source-indexed-semantics-final.log15/15 and .tmp/source-indexed-required-gates.log original auth/HTTP/conformance/selftest/strict PASS. W6 adapters through retained R1 cwd/prepared engines: .tmp/source-recovery-w6-conform.log99 reference/99 strong/29 RED-first/70 adapters +rig185 and .tmp/source-recovery-w6-selftest.log SELFTEST PASS. W6 .tmp/source-recovery-strict.log PASS with test clock unset. All owned jobs terminal; no new resource run. Stock Safe to ship wording grants no release permission.

Current runtime hashes: recovery-profile3bb676a6f10516626ce0ebd425a8498e211b50b1ab78d93510a0dc4217f82a57; recovery-stageef96cb867ba61cc74262d7a7c49060fd2aeb5d15b66448d22aa0cef30b1d023d; recovery-history5f0d72de664bb8e97c0c7cb1c0bcaaab4060fa9bf983faa270e9a080d1570e98; recovery-local3e4a3ad44d53501850d662ca7dbb0f1d1bf91ec1dd2e72e92e8f748ce85434d0. No frozen app/accepted engine/T2 core/conformance/private/soak edits, merge, deployment or private activation.

Retained failed attempts: .tmp/source-recovery-first.log called archiveProof AFTER publication and correctly got LOCAL_RECOVERY_CHANGED; test now checks proof before publication and explicitly checks refusal afterward. .tmp/source-recovery-joined.log reached the actual old-head/new-decoder defect fixed above. .tmp/source-recovery-joined-final.log compared same synthetic Buffer/Uint8Array bytes using prototype-sensitive equality; test now uses C.sameBytes. .tmp/source-recovery-composed.log omitted required retained-R1 argument, failed archive setup, and earns no product verdict; final proper invocation passed383. No ignored setup failure is counted as a behavioral kill. Earlier final .tmp/source-recovery-final.log remains the first actual joined PASS.

NEXT: join the authenticated source/rollback material to actual engine/history/current-plan projection and final guarded publication, retaining all later accepted and queued facts and original captures. No old checkpoint is fresh permission. T2 generic event committer is still absent; disclose/review the required narrow T2 amendment before core edits. K1 baseline-only all-marker deletion, schema2 issuer/old pending replay, clock/standing, scientific/consent, numeric integrator receipt, accurate private carryover/two-phone gates and capacity remain open. Same root owns product; APM owns memory. The sole ordered continuation is EARNED-DELIVERY-STATUS.md; this report does not create a second queue or acceptance.
...
## Configured-load entry, correction and history — Fable builder candidate — 2026-09-10

Delegated builder candidate for `ASSIGNMENT.md` (packet `CONFIGURED-LOAD-UI-5cd574e-builder.zip`, 1,413,261 B, SHA256 `dc895fa4c8c5a33607b828206aee6b7159adaf56279a724e636299ef62c8e553`; manifest `44410297bd9ea451ec12db28b92a28c810e9337f9a7c7a95388ab919db39a701`, 308/308 listed files and safe paths re-verified before editing). Source baseline W6 `5cd574e2e53384129c32e89cd2470d57966b7cc9` (content custody only); R1 support `bb2fd67e0209ca2a56ba7fbb50743ac38361be0f` was read, not substituted into the W6 core, and no current-R1 qualification is claimed. The pending M4 constructor `a53ff1afb821001c3af11f5147eb8d79e9162760` (accepted in scope by APM via rev168 during this build) enters ONLY as an explicitly pinned UI-test dependency composed into fresh scratch; the retained runtime is not changed and the review packet stayed immutable. Builder does not accept its own code; PM owns integration.

### Exact diff (four files; nothing else in the tree changed)

| file | before | after |
|---|---|---|
| `rebuild/m4/workout/command-panel.mjs` | `b2c3820436d9880ea5532c8120c36bb3086cee494c0d1319c8defef065dc6291` | `1a9cd8196217e438c1100e8fd38928e3d22ec1c393c8f470174878a30700c865` |
| `rebuild/m4/workout/prepared-panel.mjs` | `6620cca5372060ca9b4e03436e0bcf46adb73a66c795a63349c20a7d25041195` | `e3f316b6e935f86422affe33e3c4647d43a39eba66f7290fdb03e0a6181a7a56` |
| `rebuild/m4/workout/load-field.mjs` (new, dependency-free UI helper) | — | `f97df67bd0ffb94be55449d3d0a554e9803e62db174018da4a667c10d4c00459` |
| `rebuild/m3/w6/test/browser-configured-load.mjs` (new focused proof) | — | see `MANIFEST.json` in the candidate packet |

No storage, commands, authority, schema, issuer, source-control, engine/projector/science/frozen-law, build allowlist or unrelated styling file was touched. `diff -ruN` against the immutable original packet lists exactly these four paths plus this report.

**Entry (`mountWorkoutCommandPanel`).** An explicit `Recorded as` select with plain `Weight` / `Configuration` options sits above the entry. There is ONE load field: in Weight mode it is the unchanged `Weight (lb)` decimal field with the unchanged positive-number rule and numeric payload `{value,unit:'lb'}`; in Configuration mode the same field is relabelled `Configuration`, switches to a text keyboard, and its value is sent EXACTLY as typed as `{kind:'configuration',configuration_key}` — no trim, no lb suffix, no numeric parsing, no body-mass or zero substitution. A blank or whitespace-only key is refused with `aria-invalid`, the message names a setup, and the field keeps its text. A mixed payload is impossible by construction: one field, read by the chosen mode. The visit readback and last-record line print a numeric load as before (`40.5 lb × 8`) and a configuration as its exact key (`BW × 6`). Explicit Next resets to Weight and clears the field; focus returns to the field after Start/Next/mode change. The prescribed target stays visible and is never copied into the entry.

**History/correction (`renderHistory`).** The formatter shows `<value> lb × <reps> rep` unchanged for numeric loads and `<exact key> × <reps> rep` for configured loads; each set item now carries a `Prescribed: …` line from the retained capture cell. The correction editor keeps its field names (`correctedLoad`, `correctedReps`, `correctedReserve`, `removalReason`) and adds a `Recorded as` select plus a `Prescribed / Originally recorded / Currently recorded` reference block. The single recorded-load field is prefilled from the current load in its own form and relabelled `Recorded weight (lb)` / `Recorded configuration` by mode. On submit the chosen mode's exact value is compared to the current load (same form and same value only); a difference sends the whole closed-union value as `change.load` through the EXISTING `prepareWorkoutEdit`/`commitWorkoutEdit` path — no new caller, no partial load field. All existing status, stale, unknown-outcome, retired-editor and removal behaviour is untouched.

Why one field rather than two: a first two-input version hung the unchanged `browser-prepared-panel.mjs`, which addresses `.wcp-entry input` positionally (`inputs[1]` became the hidden configuration input, the reps stayed blank, and the held-transaction wait never resolved). A/B on a pristine original tree passed 40/40, so the interaction was mine. The single-field design keeps the entry at exactly two inputs, keeps keyboard order correct, and needed no change to any existing test.

### Actual checks (final source; Linux, Node v22.22.2, Chromium 141.0.7390.37)

```text
CONFIGURED LOAD DOM PASS — 40 focused checks (controlled outcomes; not durable evidence)
CONFIGURED LOAD RETAINED PASS — retained numeric-only runtime refuses the configured save ("Could not save. Your entries remain here. You can try again."); typed key retained; numeric save unchanged
CONFIGURED LOAD CANDIDATE PASS — 27 native checks on the pinned composition
CONFIGURED LOAD BROWSER PASS — keyboard 4 checks; 390/1024 layouts; 8 screenshots
browser-panel.mjs        PANEL DOM 57 · EXTENSION DOM 38 · EXTENSION DURABLE · PRESENTATION · DURABLE PASS  (unchanged)
browser-prepared-panel.mjs  UI DISCLOSURES 7 · ACTIVE SLOT 5+7 · PREPARED PANEL 40 PASS               (unchanged)
browser-prepared-workout.mjs  10 native assertions PASS                                              (unchanged)
browser-capture.mjs      7 native assertions PASS                                                    (unchanged)
browser-resume.mjs       WORKOUT RESUME/CORRECT 65 checks PASS                                       (unchanged)
```

Covered by the focused proof: unchanged numeric control (label, decimal keyboard, payload, readback, 16px); exact keys ` BW `, `BW`, `hold`, `55·55·50`, precomposed `café`, decomposed `cafe`+U+0301, `band: red + 2 (left)`, `  two  spaces  `, and numeric-looking `45` as an opaque key — each sent byte-exact with only two keys and read back without a suffix; blank/whitespace refusal with retained text; non-numeric text refused in Weight mode without being sent; controlled refusals 3/17/18/20, undefined outcome and thrown error retain mode, key and reps with no Saved; retained runtime refusal of a configured save with the typed key retained and one stored op; candidate durable flow on a real prepared workout — numeric set, configured set under a held IndexedDB transaction (no early Saved), second configured set, normal Finish, exact stored loads; encrypted reopen byte-identical; recovered history with prescribed/original/current; numeric→configured (`40.5 lb`→`hold`) and configured→numeric (` BW `→`45 lb`) corrections through the existing edit APIs; editor blank refusal and native quota refusal retaining the typed correction with the stored generation unchanged; `readWorkoutHistory` facts showing original load retained, current load changed, reps/reserve/capture unchanged and each correction replacing only `load`; reopening history after a refused edit; keyboard Tab from `Recorded as` to the recorded-load field with correct labels in both modes; 390/1024 fit with ≥44px controls. Screenshots: `entry-configuration-390`, `saving-configuration-390`, `retained-refuses-configuration-390`, `history-390`, `editor-numeric-to-configured-390`, `editor-refused-390`, `history-editor-390`, `history-editor-1024`. Note: the two `history-editor-*` captures were taken after the keyboard mode-switch check, so the field intentionally still holds the previous configured text under the Weight label; that text would be refused if submitted.

Pinned composition (test dependency only): preimages `schema.cjs 9d18cce9…`, `edit-values.cjs bc3e760b…`, `edit-history.cjs 3e5dd505…`, `context-values.cjs 8cd6fe62…`, `source-control-values.cjs 635ba7ec…` verified, then the two exact `run.cjs` edits applied and `entered-load.cjs` added (composed `schema.cjs 8902b4773c0aa73dca9a9751dea9f923ee61ed32658ad6c828a168782005820d`, `edit-values.cjs 6fa4fa7ccf268f44f28a2085bcfdb403b4bf463fc02ba27707873d11b61d97d3`, `entered-load.cjs 2a0cd97ec843924e6dc428f2dbb0fe3c5bf10335610a3315c205c84fc324a3a3`). Both bundles are built by the UNCHANGED `build-browser.mjs` with its font and crypto guards; the two bundle graphs differ only in those composed workout files (61 vs 63 pinned inputs). Retained sources are re-hashed after every run.

Environment: esbuild 0.28.1, @noble/hashes 2.2.0 and playwright-core reused from existing installs; `@noble/ciphers@2.4.0` and `fake-indexeddb@6.2.5` were the two missing prerequisites, authorized by Manager and installed only into isolated scratch from `npm pack` tarballs whose sha512 matched the pinned W6 lock exactly (`AnjFn0Jv…`, `CGnyrvbh…`); the `@noble/ciphers` inputs matched `cipher-imports.json`. Disclosed deviation: installed playwright-core is 1.56.1 (paired with the installed chromium-1194) while the lock pins 1.62.1; it is the test driver only, never a bundle input. No lockfile or product dependency changed.

### Limits

Synthetic unissued schema-2 lease, synthetic producer/guard and fixed clock, as in the existing proofs; desktop Chromium, not iPhone. The candidate composition is a pinned UI-test dependency, not retained-schema adoption; the retained bundle still refuses configured saves and must until PM integrates the accepted constructor. Stale-edit retention is shown through controlled outcomes and a native quota fault, not a concurrent-device race. Four adoption conditions are preserved untouched: numeric-only `unionPatch` wire refusal (not edited), pre-existing v1 fold refusal, raw Unicode values passed through unchanged with no canonical-law change, and duplicate-key rejection left in the strict parser. `run-current-head.cjs` only recomputes a hash for `command-panel.mjs` and needs `git`, so it was not run here. No engine-history/layout, R1 support, hosted, recovery, science or full-app claim; no push/merge/deploy/private data; independent Opus review and the designated integrator remain required.
