...
New source workout/engine-capture.cjs SHAa2b0ccd38b284b7be2e4f7cfaab833748251af33744ac678c2b62a48cb0ed271; test workout/test/engine-capture.test.cjs uses actual accepted source construction/factories and actual W6 capture validator/client/store. Nine cases: held-original versus current clock/alarm reconstruction, actual vector/target/effort translation, complete original-input/capture binding, baseline placeholder semantics, held one-set reader binding, incomplete vector refusal, selected debut vector/ambiguous queue handling, rest-day absence and actual Start/correction/reopen. Final combined43PASS/0FAIL/0skip in .tmp/engine-capture-clock-final.log; earlier42-case cut retained in .tmp/engine-capture-combined.log. Red .tmp/engine-capture-red.log detects actual held target0 versus required existing-reader2. One integration fixture init token typo produced ENROLLMENT_UNPROVEN; fixed to the fixture's declared synthetic token, then7PASS before selected-debut case was added. No product enrollment rule changed. Focused logs retained. R1 .tmp/engine-capture-{conform,selftest}.log uses prepared engines/oracle and M4 adapters, SUITE CONSISTENT99/99/29/70+rig185 and SELFTEST PASS. No private/frozen/golden/installed-engine change; no extra scientific verdict from parity.
