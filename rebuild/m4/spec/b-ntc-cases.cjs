'use strict';
// LANE B successor for the accepted parent carrier cases (DECISIONS:113 (1)).
// It LOADS rebuild/m4/spec/native-carriers-cases.cjs — the parent's own original
...
require('./b-ntc-successors.cjs').run('cases');
