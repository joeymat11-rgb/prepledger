'use strict';
// LANE B successor for the accepted parent carrier defect-witnesses (DECISIONS:113 (1)).
// It LOADS rebuild/m4/spec/native-carriers-defect-witnesses.cjs — the parent's own original
...
require('./b-ntc-successors.cjs').run('defect-witnesses');
