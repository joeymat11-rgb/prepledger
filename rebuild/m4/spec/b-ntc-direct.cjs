'use strict';
// LANE B successor for the accepted parent carrier direct (DECISIONS:113 (1)).
// It LOADS rebuild/m4/spec/native-carriers-direct.cjs — the parent's own original
...
require('./b-ntc-successors.cjs').run('direct');
