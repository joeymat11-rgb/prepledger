'use strict';
// LANE B successor for the accepted parent carrier legacy (DECISIONS:113 (1)).
// It LOADS rebuild/m4/spec/native-carriers-legacy.cjs — the parent's own original
...
require('./b-ntc-successors.cjs').run('legacy');
