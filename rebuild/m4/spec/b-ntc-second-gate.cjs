'use strict';
// LANE B successor for the accepted parent carrier second-gate (DECISIONS:113 (1)).
// It LOADS rebuild/m4/spec/native-carriers-second-gate.cjs — the parent's own original
...
require('./b-ntc-successors.cjs').run('second-gate');
