'use strict';
// LANE B successor for the accepted parent carrier source-carriers (DECISIONS:113 (1)).
// It LOADS rebuild/m4/spec/native-carriers-source-carriers.cjs — the parent's own original
...
require('./b-ntc-successors.cjs').run('source-carriers');
