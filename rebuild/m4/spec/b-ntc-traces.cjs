'use strict';
// LANE B successor for the accepted parent carrier traces (DECISIONS:113 (1)).
// It LOADS rebuild/m4/spec/native-carriers-traces.cjs — the parent's own original
...
require('./b-ntc-successors.cjs').run('traces');
