'use strict';
// LANE B successor for the accepted parent carrier witnesses (DECISIONS:113 (1)).
// It LOADS rebuild/m4/spec/native-carriers-witnesses.cjs — the parent's own original
...
require('./b-ntc-successors.cjs').run('witnesses');
