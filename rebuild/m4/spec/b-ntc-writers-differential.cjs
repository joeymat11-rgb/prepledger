'use strict';
// LANE B successor for the accepted parent carrier writers-differential (DECISIONS:113 (1)).
// It LOADS rebuild/m4/spec/native-carriers-writers-differential.cjs — the parent's own original
...
require('./b-ntc-successors.cjs').run('writers-differential');
