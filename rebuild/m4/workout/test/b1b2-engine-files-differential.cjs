...
const inventory=H.closedEngineInventory(),runtime=H.reconstructRuntime(),h3=H.reconstructH3();
...
console.log('B1B2 ENGINE INVENTORY: '+runtime.length+' runtime files; '+h3+' original H3 hunks; '+inventory.unchanged+' unchanged; '+inventory.added+' new evidence files; '+inventory.total+' full disk/HEAD/source entries');
