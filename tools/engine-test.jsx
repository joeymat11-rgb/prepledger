   ...
   everywhere, and the two asks made visually distinct — driven and pinned below. */
{
  ...
  ok((gm.split('padding: "13px 9px"').length - 1) === 2 && (gm.split('padding: "10px 0", margin: "-2px 0 -10px 0"').length - 1) === 2, "R15c — the ask-screen skips carry a PAINTED border, so they get the full outer/inner split (paint on the span, 64 hit on the button) — paint and slop never share a channel, even on the quiet controls");
