...
// --- migration patchV36 — additive + migratable + rollback-safe ---
{
  ...
  ok(SC === 55, "schema: SCHEMA_V is 55 (patchV55: the 8/09 re-strike — the attested correction finished in the LOG so derive-first has nothing to resurrect — the deliberate census pin; bumping SCHEMA_V must touch this line)");
...
/* N3 — rows now 21d apart: NONOVERLAPPING windows are the persistence unit */
  ...
  ok(__test.SCHEMA_V === 55, "schema: SCHEMA_V is 55 (patchV55 on top of the chain — the second deliberate census pin)");
