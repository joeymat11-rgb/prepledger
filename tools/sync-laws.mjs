...
const MUTATIONS = [
  ...
  ["sugrank-drops-undone", "pin", "a stale replica's not-yet-undone copy can win the union and resurrect the effect", `+ "|" + (x && x.undone ? "1" : "0") + "|" + _canonJ(x); }`, `+ "|" + _canonJ(x); }   /* mutant: undone is not rank */`],
