...
const MUTATIONS = [
  ...
  ["guard-counts-projections", "pin", "the guard counts machine receipts as history again — the app refuses its own migration and v7.55.x never reaches his phone", `feed: (Array.isArray(st.feed) ? st.feed.filter((f9) => !_isFeedProjection(f9)).length : 0),`, `feed: (Array.isArray(st.feed) ? st.feed.length : 0),`],
